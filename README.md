...
lista_tareas_app/ ├── main.py # Orquestador y punto de arranque ├── modelos/ │ └── tarea.py # Clase Tarea (Modelo) ├── servicios/ │ └── tarea_servicio.py # Lógica de negocio (Servicio) └── ui/ └── app_tkinter.py # Interfaz gráfica y manejo de eventos
